...
Sourced from https://github.com/Cadene/pretrained-models.pytorch (MIT License)
"""
...
class BasicConv2d(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, kernel_size, stride, padding=0) -> None:
...
class Inception(nn.Module):
    ...
    .. note::
        **Important**: In contrast to the other models the inception_v4 expects tensors with a size of
...
class InceptionV4:
    """Initialize Inceptionv4 model.
    """
    def __init__(self, num_classes=1000, pretrained='imagenet') -> None:
        self._model = None
        self.load_model(num_classes, pretrained)
    ...
    def load_model(self, num_classes, pretrained) -> None:
        ...
        if pretrained:
            ...
            self._model = Inception(num_classes=1001)
            ...
            self._model = Inception(num_classes=num_classes)
